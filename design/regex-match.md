...
| 6b | Additional Questions | `Why do you want to work at?` | "Why do you want to work at [Company]?", "Why do you want to work for [Company]?", "Why do you want to join our team?" | `/why do you want to work (at\|for)/i` | Text |
...
| 13b | Additional Questions | `Years of Python Experience` | "How many years of Python experience do you have?", "How many years with Python?" | `/how many.*years.*python\|python.*years.*experience/i` | Text |
| 14 | Additional Questions | `How did you learn about this role?` | "How did you learn about us?", "How did you hear about us?", "How did you learn about this job?", any question beginning with "How did you learn about" or "How did you hear about" | `/how did you (learn\|hear) about/i` | Text |
...
| 15b | Additional Questions | `Have you previously worked?` | "Have you previously worked in this industry?", "Have you previously worked with similar technologies?" | `/have you previously worked/i` | Y/N |
...
| 16b | Additional Questions | `Do you live in?` | "Do you currently live in San Diego area?", "Do you live in [City]?", "Do you live in the United States?" | `/do you.*live in/i` | Y/N |
