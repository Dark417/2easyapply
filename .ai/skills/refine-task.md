...
## Workflow
1. Read the current intent and inspect `design/task1-auto-flow.md` if it exists.
...
## Output Rules
- Prefer updating `design/task1-auto-flow.md` instead of scattering workflow notes across random files.
